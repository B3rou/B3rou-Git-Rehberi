...
> * Git'in gördükleri, (Working Directorydeki değişiklikleri, indexi vs) rapor eder. <br>
...
> * `file.c`: Spesifik bir dosyayı veya dizini seçip index'e eklersin. <br>
...
> * `-m "mesaj"`: Belirlediğin mesaj ile beraber index'e eklediğin dosyaların fotoğrafını çeker ve onu repoya ekler. <br>
...
> * Reponun commitlerini sırasıyla gösterir. Projenin Tarihçesidir. <br>
