...
Temizliği de hallettiğimize göre, artık hata yapmaktan korkmamıza gerek yok. Çünkü bir sonraki derste **Hata Düzeltme** butonlarını kullanmayı öğreneceğiz.

👉 **Sonraki Adım:** [1.4 - Ctrl + Z: Hataları Geri Alma Sanatı](./1.4-reset-restore.md)